...
definePageMeta({
  title: 'Privacy Policy Google Integration - CRM',
})
</script>
...
<template>
  <v-main>
    ...
    <v-container class="prose">
      ...
      <ol>
        <li>
          <h2>Data yang Kami Kumpulkan dan Tujuannya</h2>
        ...
        <li>
          <h2>Penggunaan Batasan (Limited Use) Data Gmail</h2>
        ...
        <li>
          <h2>Kontrol dan Retensi Data</h2>
          <p>
