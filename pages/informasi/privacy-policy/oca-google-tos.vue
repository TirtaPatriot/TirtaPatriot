  ...
  <v-main>
    ...
    <v-container class="prose">
      ...
      <ol>
        ...
        <li>
          <h2>Penolakan Jaminan</h2>
          <p>
            Layanan disediakan atas dasar **"sebagaimana adanya"** dan **"sebagaimana tersedia"** tanpa jaminan apa pun, baik tersurat maupun tersirat, termasuk, tetapi tidak terbatas pada, jaminan tersirat tentang kelayakan jual, kesesuaian untuk tujuan tertentu, dan non-pelanggaran.
          </p>
        </li>

        <li>
          <h2>Pembatasan Kewajiban</h2>
          <p>
